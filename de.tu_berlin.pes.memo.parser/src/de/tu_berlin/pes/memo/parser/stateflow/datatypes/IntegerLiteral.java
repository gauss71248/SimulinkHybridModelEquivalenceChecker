...
/**
 * Represents a whole-number Number. To store big numbers easily reached in hex
 * it uses not the java data type int but the data type long.
 *
...
public class IntegerLiteral extends NumericLiteral {
	...
	/**
	 * Creates a new whole-number literal with the given value.
	 *
	 * @param value
	 *           The integer value
	 */
