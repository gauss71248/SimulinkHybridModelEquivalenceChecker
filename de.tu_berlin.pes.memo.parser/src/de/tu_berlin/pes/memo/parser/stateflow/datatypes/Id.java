...
/**
 * The simplest form of an name, a single identifier. Complex (qualified) names
 * are formed by multiple identifiers conected by the dot operator (dot
 * notation).
 *
